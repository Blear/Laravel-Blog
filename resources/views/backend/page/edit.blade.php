        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input class="form-control" placeholder="标题" name="title" value="{{old('title')!=null?old('title'):$page->title}}" id="name" type="text">
                    </div>
                </div>
                <div class="form-group">
                    <label for="slug" class="col-lg-2 control-label">slug</label>
                    <div class="col-lg-10">
                        <input class="form-control" placeholder="slug" name="slug" value="{{old('slug')!=null?old('slug'):$page->slug}}" id="slug" type="text">
                    </div>
                </div>
                <div class="form-group">
                    <label for="content_original" class="col-lg-2 control-label">正文</label>
                    <div class="col-lg-10">
                        <textarea class="form-control" name="content_original" id="content_original" rows="20" placeholder="请使用 Markdown 格式书写">{{old('content_original')!=null?old('content_original'):$page->content_original}}</textarea>
                    </div>
                </div>
            </div><!-- /.box-body -->
        </div><!--box-->

        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input class="form-control" placeholder="标题" name="title" value="{{old('title')!=null?old('title'):$article->title}}" id="name" type="text">
                    </div>
                </div>
                <div class="form-group">
                    <label for="slug" class="col-lg-2 control-label">slug</label>
                    <div class="col-lg-10">
                        <input class="form-control" placeholder="slug" name="slug" value="{{old('slug')!=null?old('slug'):$article->slug}}" id="slug" type="text">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <textarea class="form-control" rows="4" placeholder="文章简介" name="description"  id="description">{{old('description')!=null?old('description'):$article->description}}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="content_original" class="col-lg-2 control-label">正文</label>
                    <div class="col-lg-10">
                        <textarea class="form-control" name="content_original" id="content_original" rows="20" placeholder="请使用 Markdown 格式书写">{{old('content_original')!=null?old('content_original'):$article->content_original}}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <select id="tags" name="tags[]" class="form-control" multiple>
                            @foreach($tags as $tag)
                                <option value="{{ $tag->name }}" {{$article->tags->contains($tag)?'selected':' '}}>{{ $tag->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>

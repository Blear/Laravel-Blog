...
@section('content')
    <form class="form-horizontal" action="{{route('admin.tag.update',$tag)}}" method="post">
        {{csrf_field()}}
        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input class="form-control" placeholder="标签名称" name="name" value="{{old('name')!=null?old('name'):$tag->name}}" id="name" type="text">
                    </div>
                </div>
            </div><!-- /.box-body -->
        </div><!--box-->
